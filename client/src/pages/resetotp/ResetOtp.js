...
export default function ResetOtp() {
  ...
  const onSubmit = async (values) => {
    try {
      ...
      const response = await axios.post("/api/auth/userReset", values);
                ...
                <Form onFinish={onSubmit}>
                  ...
                  <div className="form-outline mb-4">
                    <Form.Item name="password1" >
                      <Input type="number" id="form3Example4cg" placeholder='Enter your password' className="form-control form-control-lg" />
                    </Form.Item>                  
                  </div>
                  <div className="form-outline mb-4">
                    <Form.Item name="password2" >
                      <Input type="number" id="form3Example4cg" placeholder='Confirm your password' className="form-control form-control-lg" />
                    </Form.Item>                  
                  </div>
